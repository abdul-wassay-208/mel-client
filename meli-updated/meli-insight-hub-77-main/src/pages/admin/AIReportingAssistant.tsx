...
import { STRATEGIC_OBJECTIVES_DATA } from '@/config/hierarchyConfig';

const STRATEGIC_OBJECTIVES: Record<string, string> = Object.fromEntries(
  STRATEGIC_OBJECTIVES_DATA.map(s => [s.prefix, s.label])
);
